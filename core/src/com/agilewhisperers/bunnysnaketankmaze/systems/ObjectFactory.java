...
public class ObjectFactory {
   ...
   public void respawnFrog() {
      int x = MathUtils.random(data[0].length - 1);
      int y = MathUtils.random(data.length - 1);
      mrFrog.getBody().setPosition(x, y);
   }
}
